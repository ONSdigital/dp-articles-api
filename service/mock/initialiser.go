...
// 			},
// 			DoGetZebedeeClientFunc: func(url string) api.ZebedeeClient {
...
func (mock *InitialiserMock) DoGetZebedeeClient(url string) api.ZebedeeClient {
	...
	return mock.DoGetZebedeeClientFunc(url)
}
